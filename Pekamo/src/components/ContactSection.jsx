...
export default function ContactSection() {
  ...
  const validate = () => {
    ...
    else if (form.phone && !/^(?:\+254|0)7\d{8}$/.test(form.phone))
  ...
  const onSubmit = async (ev) => {
    ...
    if (res.ok) {
      ...
      setTimeout(() => setSubmitted(false), 10000); // 10 seconds
    } else {
              ...
              <form onSubmit={onSubmit} className={styles.form} noValidate>
                ...
                <label className={styles.field}>
                  ...
                  <select
                    ...
                    aria-required="true"
                    aria-invalid={!!errors.woodSpendBracket}
                  >
                ...
                <div className={styles.actions}>
                  ...
                  <a href="/quote" className={styles.linkButton}>
                    Go to Quote page
                  </a>
                </div>
